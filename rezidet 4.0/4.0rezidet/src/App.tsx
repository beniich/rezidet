...
import { LicensesAdminPage } from './components/pages/LicensesAdminPage';
import { CAFMDashboardPage } from './components/pages/CAFMDashboardPage';
      ...
      <div className="min-h-screen text-white relative font-sans selection:bg-orange-500 selection:text-white flex flex-col justify-between">
        ...
        {activePage === 'dashboard' ? (
          <div className="relative z-10 w-full min-h-screen">
            <CAFMDashboardPage onNavigate={handleNavigate} language={language} />
          </div>
        ) : (
          <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-8 flex-1 w-full">
            ...
            {activePage === 'licenses' && <LicensesAdminPage onNavigate={handleNavigate} language={language} />}
          </main>
        )}
